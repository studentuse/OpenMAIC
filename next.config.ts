...
const nextConfig: NextConfig = {
  ...
  // Dev-only: the dev server is reached over the LAN by a hostname other than
  // localhost (Ubuntu box at 192.168.1.41). Without this, HMR websocket
  // requests from that origin are blocked as cross-origin.
